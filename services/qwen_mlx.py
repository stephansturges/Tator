...
MIRIL_DRONE_VLM2_MLX_NOTE = (
    ...
    "fine-tuned for typed aerial visual-response tasks. It is enabled "
    ...
    entries.extend(
        [
            _external_mlx_entry(
                ...
                compatibility_note=MIRIL_DRONE_VLM2_MLX_NOTE,
                training_note=MIRIL_DRONE_VLM2_MLX_NOTE,
                model_family="gemma4",
                model_line="Miril Drone VLM2",
                dataset_context=(
                    "Compact Gemma 4-based aerial VLM trained for caption, "
                    "answer, location, and pointing tasks."
                ),
                load_strict=False,
            ),
            {
