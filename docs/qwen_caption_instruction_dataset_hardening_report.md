...
- The backend rejects malformed or unmatchable actionable review rows before
  ...
  review record only when they carry current exported synthetic text-label
  provenance; arbitrary caption0 rows are rejected before any metadata is
  written.
