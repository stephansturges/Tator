    ...
    *,
    ...
    for source, root, loader in sources:
        ...
        for raw_path in root.iterdir():
            # Registry maintenance roots (trash, transient-session state,
            # quarantines) are never datasets, even if an invalid file inside
            # them happens to resemble dataset metadata.
