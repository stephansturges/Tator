...
- Use **Caption current image** to generate a concise description of the scene. The captioner sends the current boxes/polygons as hints (with optional counts/coords) and automatically summarizes when there are too many detections.
